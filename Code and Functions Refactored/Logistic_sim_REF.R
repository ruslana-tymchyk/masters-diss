...
sim_log_1t_10K <- mapply(rerun_logistic, prob = probs,
                           MoreArgs = list(n = 60, 
                                           size = 1, 
                                           reruns = 10)) #was 10000
                         #mc.cores = 2)
...
extreme_responses <- sim_log_1t_10K %>% 
  mutate(extreme = ifelse(mean_prop_real < 0.1, 'less_than_10',
